...
* Lets to assign a user to the calendar, this way an user with editor access will access his own calendar
...
4.	Configure the settings at the administration menu >> Settings >> Booking Calendar Contact Form. 
...
2. Inserting calendar into a page.
3. Manage calendar.
4. Editing settings.
5. Calendar settings.
